...
<div class="w-100 coinListWrap">
    <div class="cryptoBtnGroup">
        <ul class="crypto_tabs clearfix">
            ...
            <li style="width:180px" v-bind:class="{'crypto_dropdn': getscClass}" class="stableCoinddclass">
...
export default {
    ...
    mounted() {
      ...
      .listen('PairingDataEvent', (e) => {
       ...
       $(document).on('click','.stableCoinddclass',function(ev) {
          ev.stopPropagation(); 
          document.body.classList.add("stable_coins_dd");
        });
            ...
            if (auth_token) {
                ...
                axios({
                    ...
                    .then(function (response) {
                        ...
                        if(from == 'BC'){
                            self.$router.push('/Trade/' + response.data.Result[0].pairing_list[0].market_symbol)
                        }        
