        ...
        <v-container class="pa-0">
            <div class="new_login_wrp">
                <div class="userregistration_box">
                    <ul>
                        <li>
                            <a href="/login" class="radius_left">Sign in</a>
                        </li>
                        <li>
                            <a href="/signup" class="radius_right activeTab">Sign up</a>
                        </li>
                    </ul>
                                    ...
                                    <div class="userregistration_form_wrp">
                                        <div v-show="signupForm">
                                            <v-form ref="form" v-model="valid">
                                                <v-col cols="12" sm="12" class="p-0">
                                                    <div class="form-group">
                                                        <p>Email Address</p>
                                                        <v-text-field placeholder="Enter your email address" v-model="email" :rules="emailRules" required single-line outlined hide-details="auto" v-on:keyup.8="hideAlertbox">
                                                        </v-text-field>
                                                    </div>
                                                </v-col>
                                                <v-col cols="12" sm="12" class="p-0 mb-5">
                                                    <div class="form-group">
                                                        <p>Referral code</p>
                                                        <v-text-field placeholder="Got a referral code? Enter here!" v-model="referralCode" single-line outlined required hide-details="auto" v-on:keyup.8="hideAlertbox">
                                                        </v-text-field>
                                                    </div>
                                                </v-col>
                                                <v-col cols="12" sm="12" class="p-0 mb-5">
                                            ...
                                            ></div>
                                                ...
                                                <v-col cols="12" sm="12" class="p-0 mb-6 clearfix">
                                                     <v-checkbox
                                                        v-model="termsnconditions"
                                                        :rules="[v => !!v || 'You must agree to continue!']"
                                                        color="success"
                                                        value="1"
                                                        class="d-inline-block m-0 float-left user_terms"
                                                        ></v-checkbox> 
                                                        <div class=" float-left pt-1">I agree to the <a :href="`${websiteUrl}termsofuse`" target="_blank">Terms of Use</a></div> 
                                                </v-col>
                                                <v-col cols="12" sm="12" class="p-0 pt-4">
                                                    <v-alert v-show="signuperr" dense outlined type="error" class="alert_txt">
                                                        {{ dispMsg }}
                                                    </v-alert>
                                                    
                                                    <v-btn x-large color="success" class="w-100" dark @click="validate">Register now</v-btn>
                                                </v-col>
                                                
                                            </v-form>
                                        </div>
                                        <div v-show="!signupForm" class="signup_msg">
                                            <h3 class="font-weight-bold mb-6">Check your email!</h3>
                                            <h6 class="mb-5">We've just sent you a confirmation email to your Inbox</h6>
                                            <p class="font-weight-normal">Kindly check your mailbox.</p>
                                        </div>
...
export default {
    ...
    data() {
        return {
            ...
            emailRules: [
                ...
                v => /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(v) || 'Provide valid email address'
            ],
            snackbar: false,
            snackbar_text: "",
            vertical: true,
    ...
    mounted: function () {
        ...
        this.referralCode = this.myResult[2];
    ...
    methods: {
        ...
        register: function () {
            ...
            let referral = this.referralCode
            let termsnconditions = this.termsnconditions
            ...
            self.$store.dispatch('register', {
                ...
                .then(response => {
                    ...
                    if (response.data.Success == true) {
                        self.snackbar_text = "Successfully registered, we sent you a confirmation link to your email."
                        self.snackbar = true
